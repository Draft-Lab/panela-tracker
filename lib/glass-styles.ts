export const glassOuter =
  "@container rounded-[2rem] bg-white/[0.04] p-1.5 ring-1 ring-white/10 transition-[transform,box-shadow] duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.35)]"
...
export const glassDivider = "divide-white/[0.06] border-white/[0.06]"
