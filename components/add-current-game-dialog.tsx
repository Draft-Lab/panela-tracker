...
export function AddCurrentGameDialog({ open, onOpenChange }: AddCurrentGameDialogProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Marque um jogo que vocês estão jogando agora</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="border-t pt-4">
              <Label className="mb-3 block">Jogadores *</Label>
              {players.length === 0 && (
